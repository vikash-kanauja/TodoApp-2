...
const DeleteTodoModal = ({ showOrHideDeleteModal, deleteTodo, toggleDeleteModal, id }) => {
  return (
    <>
      {
        showOrHideDeleteModal && (
          <div className="absolute text-center mx-auto w-[80%] top-[30%] left-[10%] bg-white border-2 px-2 py-4 rounded ">
            ...
            <div className="flex justify-between w-[80%] mx-auto text-lg">
              <button className="px-4 py-1 border rounde" onClick={() => toggleDeleteModal()}> Cancel</button>
